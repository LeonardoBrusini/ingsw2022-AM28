...
class BoardTest {
    ...
    void assignProfessor() {
        ...
        b.assignProfessor(Colour.GREEN,Tower.GREY);
        b.assignProfessor(Colour.PINK,Tower.GREY);
        b.assignProfessor(Colour.RED,Tower.WHITE);
        b.assignProfessor(Colour.YELLOW,Tower.BLACK);
        assertEquals(Tower.GREY,b.getProfessorGroup().getTower(Colour.GREEN));
        assertEquals(Tower.GREY,b.getProfessorGroup().getTower(Colour.PINK));
